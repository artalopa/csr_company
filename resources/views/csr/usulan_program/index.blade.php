    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">DATA USULAN PROGRAM CSR</span>
                    <span class="sub_title--second">Data Usulan Program CSR</span>
                </div>
                <div class="d-flex">
                    <a href="{{ route('csr-usulan-program.create-usulan-perusahaan') }}" class="me-3 btn-block__custome">
                        <span class="btn btn-green__custome btn-icon">
                            <img src="{{ asset('assets/icon/csr/company.png') }}" alt="" class="icon">
                        </span>
                        <div>
                            <small class="text-grey">
                                <p>Tambah Usulan <br> Perusahaan</p>
                            </small>
                        </div>
                    </a>
                    <a href="{{ route('csr-usulan-program.create-usulan-opd') }}" class="me-3 btn-block__custome">
                        <span class="btn btn-purple__custome btn-icon">
                            <img src="{{ asset('assets/icon/csr/tambah_usulan_opd_white.png') }}" alt="" class="icon">
                        </span>
                        <div>
                            <small  class="text-grey">
                                <p>Tambah Usulan <br> OPD</p>
                            </small>
                        </div>
                    </a>
                ...
                <div class="col-md-12 mb-2">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="sub_title">
                                <span class="fw-bolder text-grey sub_title--first">Data Usulan Program CSR - All</span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="d-flex justify-content-end">
                                <form action="" class="me-3">
                                    <input type="search" class="form-control form-control__search" placeholder="Cari Usulan Program">
                                </form>
                        ...
                        <table class="table table-borderless align-middle">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <a href="{{ route('master-opd.edit') }}" class=" btn btn-orange__custome d-block btn-icon__in">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">OPD07876562</span>
                                    </td>
                                    <td>
                                        <span class="form-control text-uppercase">Beasiswa</span>
                                    </td>
                                    <td>
                                        <span class="form-control text-uppercase">Program Prioritas</span>
                                    </td>
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">OPD345676</span>
                                    </td>
                                    <td>
                                        <span class="form-control text-uppercase">Pelatihan Digital Marketing</span>
                                    </td>
                                    <td>
                                        <span class="form-control text-uppercase">Program Reguler</span>
                                    </td>
