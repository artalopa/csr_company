    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">DATA DPA CSR PERUSAHAAN (DPA DP4)</span>
                    <span class="sub_title--second">Data Pelaksanaan Program CSR Perusahaan (DPA DP4)</span>
                </div>
                <div class="d-flex">
                ...
                <div class="col-md-12 mb-2">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="sub_title">
                                <span class="fw-bolder text-grey sub_title--first">Data Pelaksanaan Program CSR Perusahaan (DPA DP4)</span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="d-flex justify-content-end">
                                <form action="" class="me-3" style="width: 40%;">
                                    <input type="search" class="form-control form-control__search" placeholder="Cari DPA DP4">
                                </form>
                                    ...
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-center">
                                                <a href="{{ route('dpa-dp4.validation') }}" class=" btn btn-blue__custome d-block btn-icon__in">
                                                    <span>
