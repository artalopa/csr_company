...
<div class="col-md-12 mb-3">
    <h1 class="title-content__custome">DATA PERUSAHAAN</h1>
</div>
<!-- Title end -->
    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">DATA PERUSAHAAN</span>
                    <span class="sub_title--second">Data Perusaaan Pelaksana CSR</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="d-flex justify-content-between align-items-top">
                        <div class="sub_title">
                            <span class="fw-bolder text-grey sub_title--first">Data Perusahaan Pelaksana CSR</span>
                        </div>
                        <div class="d-flex">
                            <form action="" class="me-3">
                                <input type="search" class="form-control" placeholder="Cari Perusahaan">
                            </form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            <thead>
                                ...
                                <th>
                                    <span class="form-control">Kecamatan</span>
                                </th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">Car.123456</span>
                                    </td>
                                    <td>
                                        <span class="form-control">PT. Chia Jian Indonesia</span>
                                    </td>
                                    <td>
                                        <span class="form-control">Bangsri</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">Car.07876562</span>
                                    </td>
                                    <td>
                                        <span class="form-control">PT. Hanin Deisgns Indonesia</span>
                                    </td>
                                    <td>
                                        <span class="form-control">Jepara</span>
                                    </td>
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">Car.345676</span>
                                    </td>
                                    <td>
                                        <span class="form-control">PT. Tai Lung Furniture</span>
                                    </td>
                                    <td>
                                        <span class="form-control">Tahunan</span>
                                    </td>
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex">
