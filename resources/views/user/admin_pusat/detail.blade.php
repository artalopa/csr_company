    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">DETAIL ADMIN PUSAT</span>
                    <span class="sub_title--second">Detail Data Admin Pusat</span>
                </div>
                <div class="d-flex">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <label class="form-label__custome">ID Admin Pusat</label>
                            <input type="text" class="form-control form-control__profile" disabled value="ADM.1234567">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label__custome">Nama Admin Pusat</label>
