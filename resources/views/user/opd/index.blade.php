    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">ADMIN OPD</span>
                    <span class="sub_title--second">Data Admin OPD</span>
                </div>
                <div class="d-flex">
                    <a href="{{ route('admin-opd.create') }}" class="me-3 btn-block__custome">
                    ...
                    <a href="{{ route('admin-opd.index') }}" class="btn-block__custome">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="d-flex justify-content-between align-items-top">
                        <div class="sub_title">
                            <span class="fw-bolder text-grey sub_title--first">Data Admin OPD</span>
                        </div>
                        <div class="d-flex">
                                    ...
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                                <a href="{{ route('admin-opd.detail') }}" class=" btn btn-blue__custome d-block btn-icon__in">
                                                    <span>
                                                ...
                                                <a href="{{ route('admin-opd.edit') }}" class="btn btn-orange__custome d-block btn-icon__in">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
