    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">DETAIL MASTER PROGRAM</span>
                    <span class="sub_title--second">Detail Data Master Program</span>
                </div>
                <div class="d-flex">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="text" class="form-control form-control__profile" disabled value="PG-001">
                            </div>
                            <div class="col-md-12 mb-2">
                                <label class="form-label__custome">Nama Program <span>*</span></label>
                                <input type="text" class="form-control form-control__profile" disabled value="Pemberdayaan Masyarakat">
                            </div>
                        </div>
                    </div>
                </div>
