    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">TAMBAH MASTER PROGRAM</span>
                    <span class="sub_title--second">Tambah Data Master Program</span>
                </div>
                <div class="d-flex">
    ...
    <form action="">
        <div class="row row-deck">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label class="form-label__custome">ID Master Program <span>*</span></label>
                                <input type="text" class="form-control form-control__profile" placeholder="(Otomatis)">
                            </div>
                            <div class="col-md-12 mb-2">
                                <label class="form-label__custome">Nama Program <span>*</span></label>
                                <input type="text" class="form-control form-control__profile" placeholder="Tulis Nama Program">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card card-shadow">
                    <div class="card-body">
                        <h2>KETERANGAN PROGRAM</h2>
                        <div class="mb-3">
                            <label class="form-label__custome">Keterangan</label>
                            <textarea class="form-control form-control__text-area" placeholder="Tulis Keterangan Bidang" style="height: 120px;"></textarea>
                        </div>
                        <div class="">
