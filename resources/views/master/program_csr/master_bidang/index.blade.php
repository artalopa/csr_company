    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">MASTER BIDANG</span>
                    <span class="sub_title--second">Data Master Bidang</span>
                </div>
                <div class="d-flex">
                    <a href="{{ route('master-bidang.create') }}" class="me-3 btn-block__custome">
                        ...
                        <div>
                            <small  class="text-grey">Tambah Bidang</small>
                        </div>
                    </a>
                    <a href="{{ route('master-bidang.index') }}" class="btn-block__custome">
                        ...
                        <div>
                            <small class="text-grey">Data Bidang</small>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="col-md-12 mb-2">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="sub_title">
                                <span class="fw-bolder text-grey sub_title--first">Data Master Bidang</span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="d-flex justify-content-end">
                                <form action="" class="me-3">
                                    <input type="search" class="form-control" placeholder="Cari Bidang">
                                </form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            <thead>
                                ...
                                <th>
                                    <span class="form-control">ID Bidang</span>
                                </th>
                                <th>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                                <a href="{{ route('master-bidang.detail') }}" class=" btn btn-blue__custome d-block btn-icon__in">
                                                    <span>
                                                ...
                                                <a href="{{ route('master-bidang.edit') }}" class=" btn btn-orange__custome d-block btn-icon__in">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">BADAN KESATUAN BANGSA DAN POLITIK</span>
                                    </td>
                                    <td>
                                        <span class="form-control">Aktif</span>
                                    </td>
