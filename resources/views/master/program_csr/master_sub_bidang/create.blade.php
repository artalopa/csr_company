    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">TAMBAH MASTER SUB BIDANG</span>
                    <span class="sub_title--second">Tambah Data Master Sub Bidang</span>
                </div>
                <div class="d-flex">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select__custome">
                                <option value="">BADAN KEPEGAWAIAN DAERAH</option>
                                <option value="">DINAS KESEHATAN</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label__custome">Nama Sub Bidang <span>*</span></label>
                            <input type="text" class="form-control form-control__profile" placeholder="Tulis Nama Bidang">
                        </div>
                    </div>
                </div>
            </div>
