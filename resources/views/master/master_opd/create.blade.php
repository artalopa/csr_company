    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">TAMBAH MASTER OPD</span>
                    <span class="sub_title--second">Tambah Data Master OPD</span>
                </div>
                <div class="d-flex">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label class="form-label__custome">ID Master OPD <span>*</span></label>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control form-control__profile" placeholder="Tulis Nama OPD">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-label__custome">Singkatan <span>*</span></label>
                                <input type="text" class="form-control form-control__profile" placeholder="Tulis Singkatan OPD">
                            </div>
                            <div class="col-md-6 mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="text" class="form-control form-control__profile" placeholder="Website">
                            </div>
                            <div class="col-md-12 mb-2">
                                <label class="form-label__custome">Instagram</label>
                                <input type="text" class="form-control form-control__profile" placeholder="Instagram">
                            </div>
                            <div class="col-md-12 mb-2">
                                <label class="form-label__custome">Twitter</label>
                                <input type="text" class="form-control form-control__profile" placeholder="Twitter">
                            </div>
                            <div class="col-md-12 mb-4">
                                <label class="form-label__custome">Facebook</label>
                                <input type="text" class="form-control form-control__profile" placeholder="Facebook">
                            </div>
                            <div class="col-md-12">
