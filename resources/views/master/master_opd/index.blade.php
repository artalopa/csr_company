    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">MASTER OPD</span>
                    <span class="sub_title--second">Data Master OPD</span>
                </div>
                <div class="d-flex">
                    <a href="{{ route('master-opd.create') }}" class="me-3 btn-block__custome">
                        ...
                        <div>
                            <small  class="text-grey">Tambah OPD</small>
                        </div>
                    </a>
                    <a href="{{ route('master-opd.index') }}" class="btn-block__custome">
                        ...
                        <div>
                            <small class="text-grey">Data OPD</small>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="col-md-12 mb-2">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="sub_title">
                                <span class="fw-bolder text-grey sub_title--first">Data Master OPD</span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                        ...
                        <table class="table table-borderless align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">BPD</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">BAKESBANGPOL</span>
                                    </td>
                                    <td>
                                        <span class="form-control">Aktif</span>
                                    </td>
