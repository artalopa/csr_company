    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">MASTER BOBOT PENILAIAN NOMINAL</span>
                    <span class="sub_title--second">Data Master Bobot Penilaian Nominal</span>
                </div>
                <div class="d-flex">
                ...
                <div class="col-md-12 mb-2">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="sub_title">
                                <span class="fw-bolder text-grey sub_title--first">Data Master Bobot Penilaian Nominal</span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
