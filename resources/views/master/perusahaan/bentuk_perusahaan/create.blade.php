    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">TAMBAH MASTER BENTUK PERUSAHAAN</span>
                    <span class="sub_title--second">Tambah Data Master Bentuk Perusahaan</span>
                </div>
                <div class="d-flex">
