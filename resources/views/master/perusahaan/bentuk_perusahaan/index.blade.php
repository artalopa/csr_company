    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">MASTER BENTUK PERUSAHAAN</span>
                    <span class="sub_title--second">Data Master Bentuk Perusahaan</span>
                </div>
                <div class="d-flex">
                    <a href="{{ route('master-bentuk-perusahaan.create') }}" class="me-3 btn-block__custome">
                        ...
                        <div>
                            <small  class="text-grey">
                                <p>Tambah Bentuk <br> Perusahaan</p>
                            </small>
                        </div>
                    </a>
                ...
                <div class="col-md-12 mb-2">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="sub_title">
                                <span class="fw-bolder text-grey sub_title--first">Data Master Bentuk Perusahaan</span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="d-flex justify-content-end">
                                <form action="" class="me-3">
                                    <input type="search" class="form-control" placeholder="Cari Bentuk Perusahaan">
                                </form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            <thead>
                                ...
                                <th>
                                    <span class="form-control">ID Bentuk Perusahaan</span>
                                </th>
                                <th>
                                    <span class="form-control">Bentuk Perusahaan</span>
                                </th>
                                <th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">COMMANDITAIRE VENNOOTSCHAP</span>
                                    </td>
                                    <td>
                                        <span class="form-control">CV</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                                <a href="{{ route('master-bentuk-perusahaan.detail') }}" class=" btn btn-blue__custome d-block btn-icon__in">
                                                    <span>
                                                ...
                                                <a href="{{ route('master-bentuk-perusahaan.edit') }}" class=" btn btn-orange__custome d-block btn-icon__in">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">FA</span>
                                    </td>
                                    <td>
                                        <span class="form-control">Aktif</span>
                                    </td>
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <a href="{{ route('master-bentuk-perusahaan.index') }}" class=" btn btn-orange__custome d-block btn-icon__in">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                            <path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1"></path>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">PERSEROAN TERBATAS</span>
                                    </td>
                                    <td>
                                        <span class="form-control">PT</span>
                                    </td>
                                    <td>
                                        <span class="form-control">Aktif</span>
                                    </td>
