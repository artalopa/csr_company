    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">MASTER SUB SEKTOR KBLI PERUSAHAAN</span>
                    <span class="sub_title--second">Data Master Sub Sektor KBLI Perusahaan</span>
                </div>
                <div class="d-flex">
                    <a href="{{ route('master-sub-sector-kbli.create') }}" class="me-3 btn-block__custome">
                    ...
                    <a href="{{ route('master-kbli.index') }}" class="btn-block__custome">
                        <span class="btn btn-danger__custome btn-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-table-alias" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <div class="col-md-12 mb-2">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="sub_title">
                                <span class="fw-bolder text-grey sub_title--first">Data Master Sektor KBLI Perusahaan</span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="d-flex justify-content-end">
                                <form action="" class="me-3">
                                    <input type="search" class="form-control" placeholder="Cari Sub Sektor KBLI ..">
                                </form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            <thead>
                                ...
                                <th>
                                    <span class="form-control">Kode Sektor KBLI</span>
                                </th>
                                <th>
                                    <span class="form-control">Judul Sektor KBLI</span>
                                </th>
                                <th>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                                <a href="{{ route('master-sub-sector-kbli.detail') }}" class=" btn btn-blue__custome d-block btn-icon__in">
                                                    <span>
                                                ...
                                                <a href="{{ route('master-sub-sector-kbli.edit') }}" class=" btn btn-orange__custome d-block btn-icon__in">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">PERTAMBANGAN DAN PENGGALIAN</span>
                                    </td>
                                    <td>
                                        <span class="form-control">Aktif</span>
                                    </td>
