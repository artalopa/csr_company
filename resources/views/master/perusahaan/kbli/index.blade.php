    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">MASTER KBLI PERUSAHAAN</span>
                    <span class="sub_title--second">Data Master KBLI Perusahaan</span>
                </div>
                <div class="d-flex">
                    <a href="{{ route('master-sector-kbli.index') }}" class="me-3 btn-block__custome">
                        <span class="btn btn-orange__custome btn-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-table-minus" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <a href="{{ route('master-sub-sector-kbli.index') }}" class="me-3 btn-block__custome">
                        <span class="btn btn-danger__custome btn-icon">
                        ...
                        <div>
                            <small  class="text-grey">
                                <p>Sub Sektor <br>KBLI</p>
                            </small>
                        </div>
                    </a>
                    <a href="{{ route('master-kbli.create') }}" class="me-3 btn-block__custome">
                        ...
                        <div>
                            <small  class="text-grey">Tambah KBLI</small>
                        </div>
                    </a>
                    <a href="{{ route('master-kbli.index') }}" class="btn-block__custome">
                        ...
                        <div>
                            <small class="text-grey">Data KBLI</small>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="col-md-12 mb-2">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="sub_title">
                                <span class="fw-bolder text-grey sub_title--first">Data Master KBLI Perusahaan</span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="d-flex justify-content-end">
                                <form action="" class="me-3">
                                    <input type="search" class="form-control" placeholder="Cari KBLI Perusahaan">
                                </form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            <thead>
                                ...
                                <th>
                                    <span class="form-control">Kode KBLI</span>
                                </th>
                                <th>
                                    <span class="form-control">Sektor KBLI</span>
                                </th>
                                <th>
                                    <span class="form-control">Sub Sektor KBLI</span>
                                </th>
                                <th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">PERTANIAN, KEHUTANAN, DAN PERIKANAN</span>
                                    </td>
                                    <td>
                                        <span class="form-control">PERTANIAN TANAMAN, PETERNAKAN, PERBURUAN DAN KEGIATAN YBDI</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                                <a href="{{ route('master-kbli.detail') }}" class=" btn btn-blue__custome d-block btn-icon__in">
                                                    <span>
                                                ...
                                                <a href="{{ route('master-kbli.edit') }}" class=" btn btn-orange__custome d-block btn-icon__in">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">PERTANIAN, KEHUTANAN</span>
                                    </td>
                                    <td>
                                        <span class="form-control">KEHUATANAN DAN PEMANENAN KAYU DAN HASIL HUTAN SELAIN KAYU</span>
                                    </td>
                                    <td>
                                        <span class="form-control">Aktif</span>
                                    </td>
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <a href="{{ route('master-kbli.detail') }}" class=" btn btn-orange__custome d-block btn-icon__in">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                            <path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1"></path>
                                                ...
                                                <a href="{{ route('master-kbli.edit') }}" class=" btn btn-danger__custome d-block btn-icon__in">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                            <path d="M4 7l16 0"></path>
