    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">TAMBAH MASTER SEKTOR KBLI</span>
                    <span class="sub_title--second">Tambah Data Master Sektor KBLI</span>
                </div>
                <div class="d-flex">
                ...
                <div class="card card-shadow">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <textarea class="form-control form-control__text-area" placeholder="Tulis Deskripsi Sektor KBLI" style="height: 150px;"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-shadow">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control form-control__text-area" placeholder="Tulis Keterangan Sektor KBLI" style="height: 150px;"></textarea>
                        </div>
                        <div class="">
