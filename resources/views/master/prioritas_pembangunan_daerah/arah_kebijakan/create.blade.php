    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">TAMBAH MASTER ARAH KEBIJAKAN</span>
                    <span class="sub_title--second">Tambah Data Master Arah Kebijakan</span>
                </div>
                <div class="d-flex">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control form-control__profile" placeholder="Tulis Nama Arah Kebijakan">
                            </div>
                            <div>
                ...
                <div class="card card-shadow">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control form-control__text-area" placeholder="Tulis Keterangan Arah Kebijakan" style="height: 120px;"></textarea>
                        </div>
                        <div class="">
