    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">MASTER PROGRAM PMDN 90</span>
                    <span class="sub_title--second">Data Master Program PMDN 90</span>
                </div>
                <div class="d-flex">
                    <a href="{{ route('master-program-pmdn.create') }}" class="me-3 btn-block__custome">
                ...
                <div class="col-md-12 mb-2">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="sub_title">
                                <span class="fw-bolder text-grey sub_title--first">Data Master Program PMDN 90</span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="d-flex justify-content-end">
                                <form action="" class="me-3">
                                    <input type="search" class="form-control" placeholder="Cari Program PMDN 90">
                                </form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            <thead>
                                ...
                                <th style="width: 15%;">
                                    <span class="form-control">ID P.P.Pembangunan</span>
                                </th>
                                <th style="width: 15%;">
                                    <span class="form-control">ID Arah Kebijakan</span>
                                </th>
                                <th style="width: 15%;">
                                    <span class="form-control">ID P.PMDN 90</span>
                                </th>
                                <th style="width: 35%;">
                                    <span class="form-control">Penjabaran Program Prioritas Pembangunan Daerah</span>
                                </th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">202101</span>
                                    </td>
                                    <td>
                                        <span class="form-control">20210101</span>
                                    </td>
                                    <td>
                                        <span class="form-control">20210101</span>
                                    </td>
                                    <td>
                                        <span class="form-control">PROGRAM SEDIAAN FARMASI, ALAT KESEHATAN DAN MAKANAN MINUMAN</span>
                                    </td>
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                                <a href="{{ route('master-program-pmdn.detail') }}" class=" btn btn-blue__custome d-block btn-icon__in">
                                                    <span>
                                                ...
                                                <a href="{{ route('master-program-pmdn.edit') }}" class=" btn btn-orange__custome d-block btn-icon__in">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">20210102</span>
                                    </td>
                                    <td>
                                        <span class="form-control">20210101</span>
                                    </td>
                                    <td>
                                        <span class="form-control">PROGRAM REHABILITASI SOSIAL</span>
                                    </td>
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control">20210103</span>
                                    </td>
                                    <td>
                                        <span class="form-control">20210101</span>
                                    </td>
                                    <td>
                                        <span class="form-control">PENINGKATAN SDM PENYULUH PERTANIAN</span>
                                    </td>
                                    <td>
                                        <div class="form-control">
                                            <div class="d-flex justify-content-between">
