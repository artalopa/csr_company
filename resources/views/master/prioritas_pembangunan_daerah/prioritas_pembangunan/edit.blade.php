    ...
    <div class="card card-shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="sub_title">
                    <span class="fw-bolder text-grey sub_title--first">EDIT MASTER PRIORITAS PEMBANGUNAN</span>
                    <span class="sub_title--second">Edit Data Master Prioritas Pembangunan</span>
                </div>
                <div class="d-flex">
